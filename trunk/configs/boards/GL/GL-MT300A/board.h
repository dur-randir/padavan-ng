...
#define BOARD_PID		"GL-MT300A"
#define BOARD_NAME		"GL-MT300A"
#define BOARD_DESC		"GL Technologies MT300A Router"
#define BOARD_VENDOR_NAME	"GL Technologies"
#define BOARD_VENDOR_URL	"https://www.gl-inet.com"
#define BOARD_MODEL_URL		"https://www.gl-inet.com/mt300a/"
#define BOARD_BOOT_TIME		20
#define BOARD_FLASH_TIME	90
#define BOARD_GPIO_BTN_RESET	13
#undef  BOARD_GPIO_BTN_WPS		/* free pins */
#undef  BOARD_GPIO_BTN_BT1	1	/* switch to the left */
#undef  BOARD_GPIO_BTN_BT2	2	/* switch to the right */
