...
do_debug_gdb_build() {
    ...
    if [ "${CT_GDB_NATIVE}" = "y" ]; then
        ...
        native_CFLAGS="${CT_ALL_TARGET_CFLAGS} ${CT_GDB_NATIVE_EXTRA_CFLAGS}"
        native_CXXFLAGS="${CT_ALL_TARGET_CFLAGS} ${CT_GDB_NATIVE_EXTRA_CXXFLAGS}"
        native_LDFLAGS="${CT_ALL_TARGET_LDFLAGS} ${CT_GDB_NATIVE_EXTRA_LDFLAGS}"
